...
## 2. Product Concept
### 2.1 Idea Input
A household app that helps families split chores fairly and get reminders.
...
### 4.3 One-Line UVP
For [target user], **Family Chore Balance** helps [core job] by [unique mechanism], unlike [current alternative].
