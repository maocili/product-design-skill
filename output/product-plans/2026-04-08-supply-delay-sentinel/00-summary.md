# MVP Summary: Supply Delay Sentinel
...
## Idea Input
A SaaS dashboard for operations managers to detect supplier delays and act before stockouts.
...
For [target user], **Supply Delay Sentinel** helps them [core job-to-be-done] by [unique mechanism], unlike [current alternative].

## Platform Recommendation
- Recommended platform: **Web**
- Backup platform: **Mobile**
- Rationale: web signals detected (dashboard, saas)
