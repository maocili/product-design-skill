# MVP Plan: Supply Delay Sentinel
...
- Decision rationale: web signals detected (dashboard, saas)
...
### 4.3 One-Line UVP
For [target user], **Supply Delay Sentinel** helps [core job] by [unique mechanism], unlike [current alternative].
