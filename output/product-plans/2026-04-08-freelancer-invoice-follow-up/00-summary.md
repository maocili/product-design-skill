# MVP Summary: Freelancer Invoice Follow-up
...
## Idea Input
A service that helps freelancers follow up unpaid invoices faster.
...
For [target user], **Freelancer Invoice Follow-up** helps them [core job-to-be-done] by [unique mechanism], unlike [current alternative].
